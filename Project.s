...
; Strings
string_hello DCB "Hello World", 0
...
; ---- PRINT HEX OR ADDRESS ---
ITM_HEX PROC ; (R0 Hex Value)
...
ITM_INT PROC ; (Print Integer R0)
	PUSH {R1, R2, R3, R4, R5, R11, LR}		; Save previouse frame
	MOV R11, SP
	
	; Allocate max character length and clear
	SUB SP, SP, #12
